...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-nova-boolean-multi-status-field', __webpack_require__(3));
  Vue.component('detail-nova-boolean-multi-status-field', __webpack_require__(6));
  Vue.component('form-nova-boolean-multi-status-field', __webpack_require__(9));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  props: ['resourceName', 'field', 'tooltip', 'pos', 'tooltipKey', 'useArray'],
  methods: {
    mousedown: function mousedown(ev, textKey) {
    ...
    mouseenter: function mouseenter(ev, textKey) {
      this.tooltip = true;
      this.tooltipKey = textKey;
      this.pos = {
        left: ev.layerX + 15,
...
var render = function() {
  ...
  return _c(
    "div",
    {
      staticClass: "relative booleanMultiStatusIndex",
      class: "text-" + _vm.field.textAlign,
      style: "width: " + _vm.field.width + ";"
    },
    [
      _vm._l(_vm.field.value, function(value, name) {
        return _c("div", { staticClass: "inline-block" }, [
          _c(
            "div",
            {
              staticClass: "booleanMultiStatusIcon",
              on: {
                mouseenter: function($event) {
                  return _vm.mouseenter($event, name)
                },
                ...
                mousedown: function($event) {
                  return _vm.mousedown($event, name)
                }
              }
            },
            [
        ...
        ? _c(
            ...
            [
              _c(
                ...
                [_c("span", [_vm._v(_vm._s(_vm.tooltipKey))])]
              )
            ]
          )
        : _vm._e()
    ...
    [
      _c("template", { slot: "value" }, [
        _c(
          "div",
          {
            staticClass: "relative booleanMultiStatusDetail",
            class: "text-" + _vm.field.textAlign,
            style: "width: " + _vm.field.width + ";"
          },
          [
    ...
    setInitialValue: function setInitialValue() {
      ...
      if (this.field.value) {
        this.value = Object.keys(this.field.value).map(function (index) {
          return {
            key: index,
            oneValue: _this.field.value[index]
          };
        });
      } else {
        this.value = [];
    ...
    [
      _c("template", { slot: "field" }, [
        !_vm.field.readonly
          ? _c(
              "table",
              { staticClass: "booleanMultiStatusForm table w-full" },
              [
        ...
        _vm.field.readonly
          ? _c(
              "div",
              {
                staticClass: "relative booleanMultiStatusForm",
                class: "text-" + _vm.field.textAlign,
                style: "width: " + _vm.field.width + ";"
              },
              [
                _vm._l(_vm.field.value, function(booleanValue, name) {
                  return _c("div", { staticClass: "inline-block" }, [
                    _c(
                      "div",
                      {
