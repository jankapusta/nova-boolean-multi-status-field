...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-nova-boolean-multi-status-field', __webpack_require__(4));
  Vue.component('detail-nova-boolean-multi-status-field', __webpack_require__(7));
  Vue.component('form-nova-boolean-multi-status-field', __webpack_require__(10));
});
...
var render = function() {
  ...
  return _c(
    "div",
    {
      staticClass: "booleanMultiStatusIndex",
      ...
      return _c(
        ...
        [
          _c(
            ...
            [_c("boolean-icon", { key: name, attrs: { value: value } })],
            1
          ),
          _vm._v(" "),
          _vm.field.showKeysAsTooltips
            ? _c(
                "div",
                {
    ...
    [
      _c("template", { slot: "value" }, [
        _c(
          "div",
          {
            staticClass: "booleanMultiStatusDetail",
            class: "text-" + _vm.field.textAlign,
            style: "width: " + _vm.field.width + ";"
          },
          _vm._l(_vm.field.value, function(value, name) {
      ...
      _c("template", { slot: "field" }, [
        ...
        _vm.field.readonly
          ? _c(
              "div",
              {
                staticClass: "booleanMultiStatusForm",
                class: "text-" + _vm.field.textAlign,
                style: "width: " + _vm.field.width + ";"
              },
              _vm._l(_vm.field.value, function(value, name) {
